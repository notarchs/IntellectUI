...
function library:CreateWindow(name, version, icon)
	...
	Icon.ImageColor3 = Color3.fromRGB(0, 119, 255)
	...
	TitleUnderline.BackgroundColor3 = Color3.fromRGB(0, 119, 255)
	...
	function tabs:CreateTab(name)
		...
		Indicator.BackgroundColor3 = Color3.fromRGB(0, 119, 255)
		...
		function mytabbuttons:CreateFrame(name)
			...
			Page.ScrollBarImageColor3 = Color3.fromRGB(0, 119, 255)
			...
			SearchIcon.ImageColor3 = Color3.fromRGB(0, 119, 255)

			Bar_3.Name = "Bar"
			Bar_3.Parent = SearchBar
			Bar_3.BackgroundColor3 = Color3.fromRGB(0, 119, 255)
			...
			Header.BackgroundColor3 = Color3.fromRGB(0, 119, 255)
			...
			function pagebuttons:CreateButton(name, desc, callback)
				...
				spawn(function()
					local function QCZV_fake_script() -- Caller.Handler 
						...
						Sample.ImageColor3 = Color3.fromRGB(0, 119, 255)
			...
			function pagebuttons:CreateLabel(name)
				...
				Label.BackgroundColor3 = Color3.fromRGB(0, 119, 255)
				...
				_4pxShadow2px.ImageColor3 = Color3.fromRGB(0, 119, 255)
			...
			function pagebuttons:CreateSlider(name,min,max,callback)
				...
				Indicator_3.BackgroundColor3 = Color3.fromRGB(0, 119, 255)
				...
				Shadow_1.ImageColor3 = Color3.fromRGB(0, 119, 255)
				...
				TextButton_2.BackgroundColor3 = Color3.fromRGB(0, 119, 255)
				...
				Shadow_2.ImageColor3 = Color3.fromRGB(0, 119, 255)
				...
				Fade.BackgroundColor3 = Color3.fromRGB(0, 119, 255)
			...
			function pagebuttons:CreateBox(name, icon, callback)
				...
				Footer_3.BackgroundColor3 = Color3.fromRGB(0, 119, 255)
				...
				EditIcon.ImageColor3 = Color3.fromRGB(0, 119, 255)
			...
			function pagebuttons:CreateBind(name, defaultkey, callback)
				...
				Footer_2.BackgroundColor3 = Color3.fromRGB(0, 119, 255)
			...
			function pagebuttons:CreateToggle(title , desc, callback)
				...
				UIStroke.Color = Color3.fromRGB(0, 119, 255)
				...
				Dot.BackgroundColor3 = Color3.fromRGB(0, 119, 255)
